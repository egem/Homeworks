...
SortedDynamicQueue::SortedDynamicQueue(int pcItem)
{
	SORTED_DYNAMIC_QUEUE_FUNCTION("[DYNAMIC_QUEUE][FUNCTION] FUNCTION : " << __FUNCTION__ << " FILE: " << __FILE__);
...
void SortedDynamicQueue::QInsert(int pcItem)
{	
	SORTED_DYNAMIC_QUEUE_FUNCTION("[DYNAMIC_QUEUE][FUNCTION] FUNCTION : " << __FUNCTION__ << " FILE: " << __FILE__);
...
int SortedDynamicQueue::QDelete()
{
	SORTED_DYNAMIC_QUEUE_FUNCTION("[DYNAMIC_QUEUE][FUNCTION] FUNCTION : " << __FUNCTION__ << " FILE: " << __FILE__);
	if(QEmpty())
	{
	...
	else
	{
		...
		int tTempValue = m_pcFront->m_tData;
...
int SortedDynamicQueue::QFront() const
{
	SORTED_DYNAMIC_QUEUE_FUNCTION("[DYNAMIC_QUEUE][FUNCTION] FUNCTION : " << __FUNCTION__ << " FILE: " << __FILE__);
...
void SortedDynamicQueue::PrintValues() const
{
	...
	while(currNode != NULL)
	{
		std::cout << currNode->m_tData << std::endl;
		currNode = currNode->NextNodeNext();
	}
